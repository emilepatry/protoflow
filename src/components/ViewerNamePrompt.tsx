  ...
  return (
    ...
    >
      <div className="w-80 rounded-xl border border-border bg-background p-6" style={{ boxShadow: 'var(--shadow-lg)' }}>
        <h2 id="name-prompt-title" className="text-subtitle font-semibold">What's your name?</h2>
        ...
        <input
          ...
          className="mt-4 w-full rounded-lg border border-input bg-background px-3 py-2 text-label outline-none focus:border-primary"
          autoFocus
        />
        <button
          ref={buttonRef}
          ...
          disabled={!name.trim()}
          className="mt-3 w-full rounded-lg bg-primary py-2 text-label text-primary-foreground disabled:opacity-50"
        >
          Continue
        </button>
      </div>
